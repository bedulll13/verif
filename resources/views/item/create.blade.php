            ...
            <div class="relative w-full overflow-auto">
                ...
                <form action="" enctype="multipart/form-data" class="w-full space-y-3" method="POST">
                    ...
                    <div class="form-control w-full grid grid-cols-4">
                        ...
                        <input type="text" class="border-2 col-span-3 rounded border-slate-300 p-1" name="part_no">
                    </div>
                    <div class="form-control w-full grid grid-cols-4">
                        <label class="" for="">Part name</label>
                        <input type="text" class="border-2 col-span-3 rounded border-slate-300 p-1" name="part_name">
                    </div>
                    @if($customer->id==1)
                    <div class="form-control w-full grid grid-cols-4">
                        <label class="" for="">Job No</label>
                        <input type="text" class="border-2 col-span-3 rounded border-slate-300 p-1" name="job_no">
                    </div>
                    @endif
                    <div class="form-control w-full grid grid-cols-4">
                        <label class="" for="">QTY</label>
                        <input type="text" class="border-2 col-span-3 rounded border-slate-300 p-1" name="part_qty">
                    </div>
                    <div class="form-control w-full grid grid-cols-4">
